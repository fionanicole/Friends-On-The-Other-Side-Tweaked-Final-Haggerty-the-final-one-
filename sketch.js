...
function readfutureplay() {
  ...
  let startTime = 42000;
  text("I can read your future", width / 2, height*(1/5));
...
function reformationcentralplay() {
  ...
  fill(255);
  wavylinesmoveright();
  text("Reformation central!", width / 2, height * (1/3));
  text("(Reformation central!)", width / 2, height * (2/3));
}
...
function gotwantedlosthadplay() {
  ...
  if(elapsedTime>startTime+4000){
    text("(But you lost what you had!)", width / 2, height * (3 / 5));
  }
  rotateskullcircle();
}
